...
@Api(name = "subjectendpoint", namespace = @ApiNamespace(ownerDomain = "threef.com", ownerName = "threef.com", packagePath="datastore.Entities"))
public class SubjectEndpoint {
  ...
  public CollectionResponse<Subject> listSubject(
    ...
    return CollectionResponse.<Subject>builder()
      .setItems(execute)
