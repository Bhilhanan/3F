...
@Api(name = "annotationendpoint", namespace = @ApiNamespace(ownerDomain = "threef.com", ownerName = "threef.com", packagePath="datastore.Entities"))
public class AnnotationEndpoint {
  ...
  public CollectionResponse<Annotation> listAnnotation(
    ...
    return CollectionResponse.<Annotation>builder()
      .setItems(execute)
